...
import com.webank.servicemanagement.authclient.filter.Http401AuthenticationEntryPoint;
import com.webank.servicemanagement.authclient.filter.JwtClientConfig;
import com.webank.servicemanagement.authclient.filter.JwtSsoBasedAuthenticationFilter;
...
public class SpringWebConfig extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
    ...
    @Autowired
    private ServiceManagementProperties serviceManagementProperties;
