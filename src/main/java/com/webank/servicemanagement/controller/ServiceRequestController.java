...
public class ServiceRequestController {
	...
	public JsonResponse createServiceRequest(@RequestBody CreateServiceRequestRequest rquest) {
		serviceRequestService.createNewServiceRequest(rquest);
		return okay();
	}
	...
	public JsonResponse updateServiceRequest(@PathVariable(value = "service-request-id") int serviceRequestId,
			@RequestBody CompletedServiceRequestRequest request) throws Exception {
		serviceRequestService.completedServiceRequest(serviceRequestId,request);
		return okay();
	}

	@PostMapping("/{service-request-id}/attach-file/upload")
	public JsonResponse uploadServiceRequestAttachFile(@PathVariable(value = "service-request-id") int serviceRequestId,
			@RequestParam(value = "file") MultipartFile attachFile) throws Exception {
		...
		serviceRequestService.uploadServiceRequestAttachFile(serviceRequestId, attachFile.getInputStream(),
